...
const filePreviewTemplate = `<div class="col-md-12" data-file-index="{fileIndex}">
    <div class="row">
        <div class="col-md-3">
            <img src="./img/imageIcon.png" class="card-img" style="width: 50px; height: 50px;" alt="image icon">
        </div>
        <div class="col-md-4 file-name">Tekst.jpg</div>
        <div class="col-md-4"><a class="btn btn-primary text-white file-remove">X</a></div>
    </div>
</div>`;
